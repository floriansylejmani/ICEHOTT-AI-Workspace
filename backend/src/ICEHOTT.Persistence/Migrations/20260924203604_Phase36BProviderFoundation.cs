...
{
    /// <inheritdoc />
    public partial class Phase36BProviderFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.RenameIndex(
                ...
                newName: "IX_embedding_profiles_Active");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluationKind = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    AnswerRelevance = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_rag_evaluation_evidence_EmbeddingProfileId_DatasetVersion_E~",
                table: "rag_evaluation_evidence",
                columns: new[] { "EmbeddingProfileId", "DatasetVersion", "EvaluationKind", "CompletedAtUtc" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_embedding_profiles_Active",
                table: "embedding_profiles",
                newName: "IX_embedding_profiles_Status");
        }
    }
}
